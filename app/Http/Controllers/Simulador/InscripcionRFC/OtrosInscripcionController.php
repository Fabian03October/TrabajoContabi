...
class OtrosInscripcionController extends Controller
{
    ...
    public function otrasActividades()
     {
         return view('contaito.inscripcion.otros.otrosIngresos');
     }

     public function porcientoOtros(Request $request)
     {
         ...
         return view('contaito.inscripcion.otros.porcentajesOtros', compact('actividades'));
     }

     public function procesarOtros(Request $request)
     {
         ...
         return view('contaito.inscripcion.otros.mostrarObligacionesOtros', compact('actividades', 'obligaciones', 'regimen'));
     }

     public function inscribirOtros(Request $request)
    {
