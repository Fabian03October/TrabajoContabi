...
class DividendosInscripController extends Controller
{

    public $actividadEconomica;
    
     public function procesarDividendos(Request $request)
     {
         // Obtener la actividad "Pensionado" desde la base de datos
         $actividadPensionado = Actividade::where('categoria', 'Dividendos')->first(); // Ajusta 'Pensionado' si el nombre es diferente
         ...
         return view('contaito.inscripcion.Dividendos.mostrarObligacionesProfe', compact('actividadPensionado', 'obligaciones', 'regimen'));
     }
     


    public function inscribirDividendos(Request $request)
    {
