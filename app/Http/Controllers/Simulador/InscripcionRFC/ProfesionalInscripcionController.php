...
class ProfesionalInscripcionController extends Controller
{
    ...
    public function profesional()
     ...
     public function procesarProfesional(Request $request)
    {
        ...
        return view('contaito.inscripcion.profesionales.mostrarObligacionesProfe', compact('actividades', 'obligaciones', 'regimen'));
    }


    public function inscribirProfesional(Request $request)
    {
