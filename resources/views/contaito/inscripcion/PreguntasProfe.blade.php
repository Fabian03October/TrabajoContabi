            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h6>Prestas servicios profesionales de manera independiente</h6>
                        <hr class="divider">
                        <form action="{{ route('inscripcion.procesar') }}" method="POST">
                            @csrf
                            <h6>
                            Los servicios independientes los prestas:</h6>
                            <div class="checkbox-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="patron_mexico" name="income[]" value="patron_mexico">
                                    <label class="form-check-label" for="patron_mexico">Más de una vez al año (periódicamente)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="internacional" name="income[]" value="internacional">
                                    <label class="form-check-label" for="internacional">Sólo una vez al año (esporádicamente) y tendrás oficinas</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="internacional" name="income[]" value="internacional">
                                    <label class="form-check-label" for="internacional">Sólo una vez al año (esporádicamente) y no tendrás oficinas
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="checkbox-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="patron_mexico" name="income[]" value="patron_mexico">
                                    <label class="form-check-label" for="patron_mexico">Tendrás trabajadores asalariados (pagarás sueldos y salarios)</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="internacional" name="income[]" value="internacional">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="internacional" name="income[]" value="internacional">
                                    <label class="form-check-label" for="internacional">No tendrás trabajadores o asimilados a salarios
