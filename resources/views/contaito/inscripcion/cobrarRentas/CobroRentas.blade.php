            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr class="divider">
                        <form action="{{ route('inscripcion.porcientoCobroRentas') }}" method="POST">
                            @csrf
                            <div id="toggle-profesionales" class="toggle-button">
                                <span>Cobras rentas por el alquiler de casa habitación, oficinas, locales</span>
                                <span id="toggle-icon" class="toggle-icon">➕</span>
                            </div>

                            <div id="checkbox-container" style="display: none;">
                                <div class="checkbox-group text-left">
                                    @foreach (App\Models\Actividade::where('categoria', 'CobroRentas')->get() as $actividad)
