            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr class="divider">
                        <form action="{{ route('inscripcion.procesarOtro') }}" method="POST">
                            @csrf
                                            ...
                                            <tr id="actividad-{{ $actividad->id }}">
                                                ...
                                                <td style="border: 1px solid #dcdcdc;">
                                                    <select class="form-select" name="forma_actividad[]">
                                                        ...
                                                        <option value="Como representante de copropiedad">Como representante de copropiedad</option>
                                                        <option value="Como representado de copropiedad que pagará por cuenta propia">Como representado de copropiedad que pagará por cuenta propia</option>
                                                        <option value="Como representado de copropiedad que pagará por cuenta propia">Como representado de copropiedad que pagará por cuenta propia</option>
                                                    </select>
                                                </td>
                                                <td style="border: 1px solid #dcdcdc;">
                            ...
                            <div class="continue-btn">
                                <a href="{{ route('inscripcion.CobroRentas') }}" class="btn btn-secondary" style="color: black; margin-right: 10px;" title="Regresar al inicio">
