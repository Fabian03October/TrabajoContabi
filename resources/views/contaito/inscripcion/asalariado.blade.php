                        ...
                        <form action="{{ route('inscripcion.procesar') }}" method="POST">
                            ...
                            <div class="checkbox-group">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="patron_mexico">Provienen de un patrón en México</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="internacional" name="income[]" value="internacional">
                                    <label class="form-check-label" for="internacional">Provienen de embajadas, organismos internacionales o extranjeros</label>
                                </div>
                            </div>
