            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr class="divider">
                        <form action="{{ route('inscripcion.inscribirDividendos') }}" method="POST">
                            @csrf
