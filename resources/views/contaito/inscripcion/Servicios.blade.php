            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <H6>Cobras rentas por el alquiler de casa habitación, oficinas, locales</H6>
                        <div class="activity-container">
                            <!-- Ejemplo de actividad -->
                            <div class="activity-card">
                                    <label for="Servicios">
                                        <img src="{{ asset('img/Servicios.png') }}" alt="Servicios  ">
                                        <h6>Plataformas Tecnologicas<br><small>Persona física</small></h6>
                                        <input type="checkbox" id="Servicios" name="activities[]" value="Servicios">
                                    </label>
                                </div>
                            </div>
                        </div>
